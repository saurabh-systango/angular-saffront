(function () {
     ...
     angular.module('contact').factory('contactDataServices', contactDataServices);

     function contactDataServices($q, $http, config, toastr, $sessionStorage) {
        ...
        obj.getAccountsDetails = function(data){  
            ...
            $http.get(config.apiContact +"get/listview?input_param="+data,  configHeader).success(function(data) {
         ...
         obj.getAccountFiled = function(data){  
            var deferred = $q.defer();
            $http.get(config.apiContact +"/fields",  configHeader).success(function(data) {
              deferred.resolve(data);
            })
            .error(function() {
              deferred.reject();
        ...
        obj.saveAccountsDetails = function(data){  
            var deferred = $q.defer();
            $http.get(config.apiContact +"/save",  configHeader).success(function(data) {
              deferred.resolve(data);
            })
            .error(function() {
              deferred.reject();
        ...
        obj.getConvert = function(data){  
            var deferred = $q.defer();
            $http.get(config.apiContact +"convert/get?input_param="+data,  configHeader).success(function(data) {
              deferred.resolve(data);
            })
            .error(function() {
              deferred.reject();
    ...
    obj.assignAccount = function(data){ 
        ...
        obj.detailAccountsDetails = function(data){  
            var deferred = $q.defer();
            $http.get(config.apiContact+data+"/detailview",  configHeader).success(function(data) {
              deferred.resolve(data);
            })
            .error(function() {
              deferred.reject();
